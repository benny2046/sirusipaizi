                ...
                <div class="row g-4">
                    <div class="col-sm-4">
                        <div class="border-start border-light ps-4">
                            ...
                            {{-- <div class="stats-figure" data-toggle="counter-up">{{ $availableRoomCount }}</div> --}}
                ...
                <div class="owl-carousel header-carousel">
                    <div class="owl-carousel-item position-relative">
                        ...
                        <div class="owl-carousel-text">
                            {{-- <h1 class="display-1 text-white mb-0">RSP</h1> --}}
                        </div>
                    </div>
                    <div class="owl-carousel-item position-relative">
                        <img class="img-fluid" src="{{ url('landingpage') }}/img/lazna.jpg" alt="" />
                        <div class="owl-carousel-text">
                            {{-- <h1 class="display-1 text-white mb-0">IZI</h1> --}}
                        </div>
                    </div>
                    <div class="owl-carousel-item position-relative">
                        <img class="img-fluid" src="{{ url('landingpage') }}/img/logo.png" alt="" />
                        <div class="owl-carousel-text">
                            {{-- <h1 class="display-1 text-white mb-0">Sumbar</h1> --}}
                        </div>
                    </div>
                </div>
            </div>
