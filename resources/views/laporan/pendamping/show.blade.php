    ...
    <div class="col-12 col-md-8">
        <div class="app-card app-card-settings shadow-sm p-4">
            <div class="app-card-body">
                ...
                <div class="mb-2">
                    <strong>Nama Pasien :</strong> {{ $laporanpasien->nama_pasien }}
                </div>
                <div class="mb-2">
                ...
                <div class="mb-2">
                    <strong>Nama Pendamping Penyakit :</strong> {{ $laporanpasien->nama_pendamping }}
                </div>
                <div class="mb-2">
                    <strong>Tanggal Check In :</strong> {{ $laporanpasien->created_at }}
                </div>
                <div class="mb-2" type="">
                    <strong>Tanggal Masuk :</strong> {{ $laporanpasien->tanggal_masuk }}
                </div>
                <div class="mb-2" type="">
                    <strong>Tanggal Check Out :</strong> {{ $laporanpasien->tanggal_checkout }}
                </div>
